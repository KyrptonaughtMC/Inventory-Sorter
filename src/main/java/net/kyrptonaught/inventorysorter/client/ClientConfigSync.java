...
import net.kyrptonaught.inventorysorter.network.PlayerInventorySortingPreference;
...
public class ClientConfigSync {
    ...
    public static void syncConfigToServer(NewConfigOptions config, NetworkingPlatform networking) {
        ...
        networking.sendToServer(new PlayerInventorySortingPreference(config.allowPlayerInventorySorting));
